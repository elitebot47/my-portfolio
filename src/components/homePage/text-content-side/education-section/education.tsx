...
export default async function Education({ className }: { className?: string }) {
  return (
    <div className={`${className} `}>
      ...
      <div className="lg:h-24 dark:bg-white/10  bg-black/10 backdrop-blur-sm shadow-inner shadow-black/15 dark:shadow-white/15 rounded-2xl lg:p-3.5 p-2.5  w-full">
