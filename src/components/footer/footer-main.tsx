...
export default function Footer() {
  return (
    <footer className="h-fit lg:text-start text-center py-1.5 bg-accent/50 px-8 lg:py-2">
      <div className="lg:text-lg flex justify-center items-center text-foreground gap-x-2 leading-none">
        ...
        <Link
          ...
          className="font-semibold duration-300 hover:text-blue-400 transition align-middle"
        >
          Rishab Yadav
        </Link>
      </div>
